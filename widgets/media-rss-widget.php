...
class nggMediaRssWidget extends WP_Widget {
	...
	*/
   	function nggMediaRssWidget() {
		$widget_ops = array('classname' => 'ngg_mrssw', 'description' => __( 'Widget that displays Media RSS links for NextCellent Gallery.', 'nggallery') );
		$this->WP_Widget('ngg-mrssw', __('NextCellent Media RSS', 'nggallery'), $widget_ops);
	}    
