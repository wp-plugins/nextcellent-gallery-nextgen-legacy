...
class nggSlideshowWidget extends WP_Widget {
	...
	function nggSlideshowWidget() {
		$widget_ops = array('classname' => 'widget_slideshow', 'description' => __( 'Show a NextCellent Gallery Slideshow', 'nggallery') );
		$this->WP_Widget('slideshow', __('NextCellent Slideshow', 'nggallery'), $widget_ops);
	}
